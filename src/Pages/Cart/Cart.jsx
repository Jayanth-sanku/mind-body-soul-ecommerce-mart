    ...
    return (
        <>
            ...
            <div className="cartBox">
                ...
                {cart.length === 0 ? (<div className="emptyCart"><h3>You have No Items in Your Cart</h3></div>) : (<div className="cart">
                    <div className="cartItemsDiv">
                        {
                            cart.map((item) => {
                                const { _id, name, img, price, originalPrice, rating, quantity } = item;
                                return (
